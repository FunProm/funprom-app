function renderStackedCards(questions) {
    ...
    function setOverlayOpacity() {
        ...
        bottomOpacity = (((translateY + (elementHeight) / 2) / 100));
    ...
    // }
    //
    // function isRight(translateX, height){
    //     return translateX > height/2;
    // }
    // function isTop(translateY, height){
    //     return translateY < -1*height/2;
    // }
    // function isBottom(translateY, height){
    ...
    function gestureEnd(evt) {
        ...
        if (!(currentPosition >= maxElements)) {
            ...
            // if(isLeft(translateX, evt.target.offsetWidth)){
            //     console.log("isLeft")
            // } else             if(isRight(translateX, evt.target.offsetWidth)){
            //     console.log("isRight")
            // } else             if(isTop(translateY, evt.target.offsetHeight)){
            //     console.log("isTop")
            // } else            if(isBottom(translateY, evt.target.offsetHeight)){
